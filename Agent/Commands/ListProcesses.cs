...
namespace Agent.Commands
{
    public class ListProcesses : AgentCommand
    {
        ...
        {
            var results = new SharpSploitResultList<ListProcessesResults>();
            var processes = Process.GetProcesses();

            foreach (var process in processes)
            {
                var result = new ListProcessesResults
                {
    ...
    public sealed class ListProcessesResults : SharpSploitResult
    {
